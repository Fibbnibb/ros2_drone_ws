...
class BoidsDroneSwarm(Node):
    def __init__(self, namespace, is_leader=False, min_separation=0.61):
        ...
        self.max_speed = 14.0                  # Maximum speed when following (m/s)
        ...
        self.max_position_jump = 3.5  # Maximum allowed jump in position (m)
...
def main(args=None):
    ...
    try:
        ...
        print("Follower drones (drone2, drone3): Will follow using Boids algorithm")
