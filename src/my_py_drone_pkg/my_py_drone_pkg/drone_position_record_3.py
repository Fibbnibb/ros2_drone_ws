...
class DualDronePositionRecorder(Node):
    def __init__(self):
        super().__init__('dual_drone_position_recorder')
        ...
        self.drone_ids = ['drone1', 'drone2', 'drone3', 'drone4']
        ...
        # Create subscriptions for each drone - use a different variable name to avoid conflict
        ...
        self.get_logger().info("Dual drone position recorder started")
    ...
    def save_to_csv(self):
        ...
        if any_data_saved and combined_data:
            ...
            combined_filename = f"{self.output_dir}/all_drn_position_test_2_6_{timestamp}.csv"
...
def main(args=None):
    ...
    node = DualDronePositionRecorder()
